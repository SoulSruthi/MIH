...
| **Stripe Live Secret** | `sk_live_[0-9a-zA-Z]{24,}` | sk_live_REDACTED_EXAMPLE_KEY |
| **Stripe Live Pub** | `pk_live_[0-9a-zA-Z]{24,}` | pk_live_REDACTED_EXAMPLE_KEY |
| **OpenAI** | `sk-[a-zA-Z0-9]{20,}` | sk-proj-abc123def456... |
| **GitHub PAT** | `ghp_[a-zA-Z0-9]{36}` | ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdef12 |
| **GitHub OAuth** | `gho_[a-zA-Z0-9]{36}` | gho_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdef12 |
| **Google API Key** | `AIza[0-9A-Za-z_-]{35}` | AIzaSyD-abc123-def456-ghi789-jkl012 |
